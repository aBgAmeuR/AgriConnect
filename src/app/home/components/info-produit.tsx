...
export default function InfoSection() {
  return (
    <div className="w-full h-[305px] px-[41px] py-3 justify-center items-center gap-[71px] flex flex-col">
      <div className="w-[944px] h-[82px] text-center text-black text-[32px] font-normal leading-tight">Pourquoi commander sur agriconnect ?</div>
